 ...
 * against — see ../lkm4ctr_checker for the same IS_ENABLED() pattern).
 *
 ...
 * this), so CONFIG_CGROUPS is used as its proxy, matching lkm4ctr_checker.
 */
...
/*
 * shadow_ns_diag_snprintf() - see shadow_ns_diag.c. Renders the current
