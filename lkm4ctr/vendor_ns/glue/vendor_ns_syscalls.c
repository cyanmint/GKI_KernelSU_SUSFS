...
/*
 * vendor_ns_syscalls.c - syscall hook handlers for vendor_ns.
...
static const char * const vendor_ns_unshare_names[] = {
	"__arm64_sys_unshare", "__x64_sys_unshare", "sys_unshare", NULL,
};
static const char * const vendor_ns_setns_names[] = {
	"__arm64_sys_setns", "__x64_sys_setns", "sys_setns", NULL,
};
static const char * const vendor_ns_clone_names[] = {
	"__arm64_sys_clone", "__x64_sys_clone", "sys_clone", NULL,
};
static const char * const vendor_ns_clone3_names[] = {
	"__arm64_sys_clone3", "__x64_sys_clone3", "sys_clone3", NULL,
};
static const char * const vendor_ns_fork_names[] = {
	"__arm64_sys_fork", "__x64_sys_fork", "sys_fork", NULL,
};
static const char * const vendor_ns_vfork_names[] = {
...
#else
#error "vendor_ns: unsupported architecture"
#endif

static long vendor_ns_hook_unshare(const struct pt_regs *regs)
{
...
static long vendor_ns_hook_setns(const struct pt_regs *regs)
{
...
static void vendor_ns_clone_track(long ret, unsigned long vns_flags)
{
	struct nsproxy *new_nsp = NULL;
...
static long vendor_ns_hook_clone(const struct pt_regs *regs)
{
	struct pt_regs regs_copy = *regs;
	unsigned long flags = vns_sys_arg0(regs);
	unsigned long vns_flags = flags & VNS_CLONE_FLAGS;
	...
	vendor_ns_clone_track(ret, vns_flags);
	return ret;
}

static long vendor_ns_hook_clone3(const struct pt_regs *regs)
{
...
static long vendor_ns_hook_fork(const struct pt_regs *regs)
{
	long ret = real_sys_fork(regs);
	vendor_ns_clone_track(ret, 0);
	return ret;
}

static long vendor_ns_hook_vfork(const struct pt_regs *regs)
{
...
static struct shadow_hook vendor_ns_unshare_hook =
	SHADOW_HOOK(vendor_ns_unshare_names, vendor_ns_hook_unshare, &real_sys_unshare);
static struct shadow_hook vendor_ns_setns_hook =
	SHADOW_HOOK(vendor_ns_setns_names, vendor_ns_hook_setns, &real_sys_setns);
static struct shadow_hook vendor_ns_clone_hook =
	SHADOW_HOOK(vendor_ns_clone_names, vendor_ns_hook_clone, &real_sys_clone);
static struct shadow_hook vendor_ns_clone3_hook =
	SHADOW_HOOK(vendor_ns_clone3_names, vendor_ns_hook_clone3, &real_sys_clone3);
static struct shadow_hook vendor_ns_fork_hook =
	SHADOW_HOOK(vendor_ns_fork_names, vendor_ns_hook_fork, &real_sys_fork);
static struct shadow_hook vendor_ns_vfork_hook =
	SHADOW_HOOK(vendor_ns_vfork_names, vendor_ns_hook_vfork, &real_sys_vfork);

struct shadow_hook *vendor_ns_core_hooks[] = {
	&vendor_ns_unshare_hook,
	&vendor_ns_setns_hook,
	&vendor_ns_clone_hook,
	&vendor_ns_clone3_hook,
	&vendor_ns_fork_hook,
	&vendor_ns_vfork_hook,
	NULL,
};
