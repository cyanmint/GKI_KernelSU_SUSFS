...
`../README.md` for the umbrella overview). It keeps a shadow copy of
cgroup-v1-style device allow/deny rules and can now enforce that policy
transparently at real device-open points. It has no dependency on any other
shadow module.
