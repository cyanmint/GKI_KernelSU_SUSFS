 ...
 *
 * The shadow_ctr.ko cgroup-device compatibility subsystem retains the
 * transparent device-open hook points used by the shadow_ctr family on kernels without
